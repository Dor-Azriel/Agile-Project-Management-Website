...
from pages.views import task_views, task_sorted_by_date, home_view, task_sorted_by_done, task_detail,dynamic_view
...
urlpatterns = [
    ...
    # path('tasks/add-commento<int:id>', add_C, name="add_comment"),
